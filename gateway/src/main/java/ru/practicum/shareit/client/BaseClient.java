...
public class BaseClient {
    ...
    protected ResponseEntity<Object> get(String path, Integer userId, CommentDto commentDto) {
        return get(path, userId, commentDto);
    }

    protected ResponseEntity<Object> get(String path, Integer bookingId, String state, Integer userId) {
        return get(path, bookingId, state, userId);
    }
